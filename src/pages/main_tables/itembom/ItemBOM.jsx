...
const ItemBOM = () => {
  ...
  const postProcess = (data) => {
    ...
    processedList = processedList.filter((item, index, self) => index === self.findIndex(t => t.code === item.code));
        ...
        <div>
          {userPerm && userPerm.perm_update_main === '1' ? (
            <Button
              ...
              onClick={() => {
                history.push({pathname: '/create_item_BOM', state: {product_code: record.code, backUrl: '/itemBOM'}})
              }}
            >
              <EditOutlined />
            </Button>
            ...
            titleRightAction = {()=>
              userPerm && userPerm.perm_create_main === '1' ? (
                <Button
                  ...
                  onClick={()=>{
                    history.push({pathname: '/create_item_BOM', state: {product_code: ''}})
                  }}
                >
