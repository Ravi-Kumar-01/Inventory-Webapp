...
import SettingsRolesAndPermissions from "./pages/settings/general/SettingsRolesAndPermissions";
          ...
          render={() => (
            <AuthRoute>
              <div className="autoRouteWidth">
                ...
                />
                <Route path="/create_embedded_device" exact component={CreateEntityEmbeddedDevice}/>
